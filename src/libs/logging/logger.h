...
class Logger
{
 public:
  ...
  virtual void log(LogLevel level, const char *component, fawkes::Exception &e);
  virtual void log_debug(const char *component, fawkes::Exception &e)              = 0;
  virtual void log_info(const char *component, fawkes::Exception &e)               = 0;
  virtual void log_warn(const char *component, fawkes::Exception &e)               = 0;
  virtual void log_error(const char *component, fawkes::Exception &e)              = 0;
